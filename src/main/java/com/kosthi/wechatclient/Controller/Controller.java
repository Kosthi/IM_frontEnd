...
//import com.kosthi.wechatclient.Model.Data.Userdata;
...
//import com.kosthi.wechatclient.View.Dialog;
...
//    private final AlterPerson alterPerson;
//    private final HeadProtrait headProtrait;
...
//                                mainWindow.addFriend("head2", "12", "not bad", friendPage);
//                                // }
//
...
//                                int i = MsgData.accountList.indexOf("12");
//                                if (i != -1) {
...
//            String accountRegExp = "^[0-9,a-zA-Z\\u4e00-\\u9fa5]{1,15}$";
//            String nameRegExp = "^[a-z,A-Z\\u4e00-\\u9fa5]{1,100}$";
//            String phoneRegExp = "^(((13[0-9])|(15[0-3][5-9])|(18[0,5-9]))\\d{8})|(0\\d{2}-\\d{8})|(0\\d{3}-\\d{7})$";
//            String passwordReExp = "^[a-z,A-Z0-9]{6,20}$";
//            String rePasswordRegExp = "^[a-z,A-Z0-9]{6,20}$";
//
//            if (account.isEmpty() || name.isEmpty() || phone.isEmpty() || password.isEmpty() || rePassword.isEmpty()) {
//                if (account.isEmpty()) {
...
//            String phoneRegExp = "^(13[0-9]|14[01456879]|15[0-35-9]|16[2567]|17[0-8]|18[0-9]|19[0-35-9])\\\\d{8}$";
//            String ageRegExp = "^\\d{1,3}$";
//            String passwordReExp = "^[a-zA-Z0-9]{6,20}$";
//            String rePasswordRegExp = "^[a-zA-Z0-9]{6,20}$";
//            if (account.isEmpty() || name.isEmpty() || password.isEmpty() || rePassword.isEmpty() || age.isEmpty() || phone.isEmpty()) {
//                if (account.isEmpty()) {
...
//                }
//            } else if (!Pattern.matches(accountRegExp, account) || !Pattern.matches(nameRegExp, name) || !Pattern.matches(passwordReExp, password) || !Pattern.matches(rePasswordRegExp, rePassword) || !Pattern.matches(ageRegExp, age)) {
//                if (!Pattern.matches(accountRegExp, account)) {
...
//                            }
//                            try {
//                                database.exec("INSERT INTO user VALUES(?,?,?,?,?,?,?,?,?,?)", account, password, name, sex, age, phone, "", "", userdata.getHead(), "background1");
//                                register.close();
//                                register.clear();
//                                dialog.show();
//                            } catch (SQLException e) {
...
//                    friendPage.setFriendData(user, ((Label) $(mainWindow, "Y_account")).getText());
//                    friendPage.show();
//                } catch (SQLException e) {
//                    e.printStackTrace();
//                }
