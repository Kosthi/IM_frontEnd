...
public class DatabaseModel {
    ...
    private String url = "jdbc:mysql://127.0.0.1:3306/wechat?createDatabaseIfNotExist=true&&serverTimezone=UTC&useUnicode=true&characterEncoding=utf-8";
    private String userName = "root";
    private String password = "@Wu20021011";
     ...
     * @param data
     * @return
     * @throws SQLException 第一个参数是你要选出来的选项 比如是name 还是 age 等等
     ...
     * @param tableName
     * @param data
     * @throws SQLException 第一个参数是你要插入的表名 第二个参数是条件
